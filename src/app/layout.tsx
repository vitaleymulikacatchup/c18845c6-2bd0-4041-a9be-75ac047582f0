...
export const metadata: Metadata = {
  title: "Grand Heritage Hotel - Luxury Accommodations & World-Class Service",
  description: "Experience luxury redefined at Grand Heritage Hotel. Premium rooms, award-winning spa, fine dining, and exceptional service in the heart of the city.",
  keywords: "luxury hotel, 5-star accommodation, premium suites, spa wellness, fine dining, business travel, luxury hospitality",
  metadataBase: new URL("https://grandheritageotel.com"),
  alternates: {
    canonical: "https://grandheritageotel.com"
  },
  openGraph: {
    title: "Grand Heritage Hotel - Luxury Accommodations & World-Class Service",
    description: "Experience luxury redefined at Grand Heritage Hotel. Premium rooms, award-winning spa, fine dining, and exceptional service in the heart of the city.",
    siteName: "Grand Heritage Hotel",
    images: [
      {
        url: "https://images.pexels.com/photos/189295/pexels-photo-189295.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "Luxurious hotel lobby with elegant decor"
      }
    ],
    type: "website"
  },
